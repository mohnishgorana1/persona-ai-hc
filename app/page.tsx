      ...
      <div className="flex-1 flex flex-col h-full w-full relative min-w-0 bg-neutral-950">
        ...
        {!isNameSet ? (
          <div className="flex-1 flex flex-col items-center justify-center px-4 relative z-10">
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-orange-900/20 via-neutral-950 to-neutral-950 -z-10"></div>
            ...
            <div className="bg-neutral-900/80 backdrop-blur-xl border border-neutral-800 p-8 sm:p-10 rounded-3xl w-full max-w-md shadow-2xl flex flex-col items-center text-center transform transition-all">
              <div className="w-16 h-16 bg-gradient-to-br from-orange-500 to-orange-700 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-orange-900/30">
              ...
              <div className="max-w-4xl mx-auto relative">
                ...
                >
                  <textarea
                    ...
                    className="flex-1 max-h-32 min-h-[44px] bg-transparent resize-none px-4 py-3 focus:outline-none text-neutral-200 placeholder-neutral-500 text-base"
                    rows={1}
                  />
                  <button
                    type="submit"
                    disabled={!input.trim() || isLoading}
                    className="p-3 mb-0.5 bg-orange-800 text-white rounded-full hover:bg-orange-500 disabled:bg-neutral-800 disabled:text-neutral-600 transition-colors flex-shrink-0 shadow-md"
                  >
                    <Send size={18} />
                  </button>
                </form>
